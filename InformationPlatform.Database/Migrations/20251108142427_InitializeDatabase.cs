    ...
    public partial class InitializeDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DbChatDbUser", x => new { x.ChatsId, x.ParticipantsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DbChatDbUser_Users_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyHtml = table.Column<string>(type: "text", nullable: false),
                    DbUserId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DbMessageId = table.Column<Guid>(type: "uuid", nullable: true),
                    DbPostId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Images_Messages_DbMessageId",
                        column: x => x.DbMessageId,
                        principalTable: "Messages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Images_Posts_DbPostId",
                        column: x => x.DbPostId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DbChatDbUser_ParticipantsId",
                table: "DbChatDbUser",
                column: "ParticipantsId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_DbMessageId",
                table: "Images",
                column: "DbMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_DbPostId",
                table: "Images",
                column: "DbPostId");
